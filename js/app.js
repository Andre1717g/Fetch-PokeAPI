...
const pintaCard = (pokemon) => {
    ...
    clone.querySelector('.card-body-text').textContent = pokemon.exp;

    clone.querySelectorAll('.card-footer-social h3')[0].textContent = pokemon.hp + ' k';
    clone.querySelectorAll('.card-footer-social h3')[1].textContent = pokemon.ataque + ' k';
